...
def call_soma(request = request):
    ...
    try:
        ...
        ret = json.dumps({'resultado': par1 + par2,
                          'operacao': "soma",
                          'mensagem': "Atividade 1",
                          'autor': "Claudio Santos, Bianca Firmino"}, cls=NpEncoder)
...
def call_divisao(request = request):
    print(f"Sou o processo server, id: {os.getpid()}, thread: {threading.current_thread().ident}")
    print(request.values)
    ...
    try:
        ...
        try:
            ...
            raise Exception("Os parâmetros da divisao devem ser numéricos.")
...
def call_subtracao(request = request):
    print(f"Sou o processo server, id: {os.getpid()}, thread: {threading.current_thread().ident}")
    print(request.values)
    ...
    try:
        ...
        try:
            ...
            raise Exception("Os parâmetros da subtracao devem ser numéricos.")
...
def call_multiplicacao(request = request):
    print(f"Sou o processo server, id: {os.getpid()}, thread: {threading.current_thread().ident}")
    print(request.values)
    ...
    try:
        ...
        try:
            ...
            raise Exception("Os parâmetros da multiplicacao devem ser numéricos.")
